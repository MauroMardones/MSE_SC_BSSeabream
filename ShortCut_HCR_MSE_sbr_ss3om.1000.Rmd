...
save(mp.fixexFmsy,
     file="rdata/mps.ftune.sbr1000_MM.rdata")
```

load outputs from  `run()` function

```{r, echo=FALSE}
load(file="rdata/mps.ftune.sbr1000_MM.rdata",
     verbose=T)
...
```{r, eval=FALSE, fig.height=7,fig.width=9,warning=FALSE,message=FALSE, fig.cap = paste0("Initial OM and the MSE forecast horizon under a fixed $F_{tgt}$ rule and 6 HCR hockey-stick scenarios")}
...
```{r, eval=FALSE, fig.height=7,fig.width=9,warning=FALSE,message=FALSE, fig.cap = paste0("Median MSE forecast horizon under a fixed $F_{tgt}$ rule and 6 HCR scenarios")}
...
```{r, eval=FALSE, fig.height=9,fig.width=8,warning=FALSE,message=FALSE, fig.cap = paste0("Performance: Long-term performance evaluation")}
